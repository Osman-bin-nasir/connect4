...
function Login() {
    ...
    return (
        <div className="min-h-screen pt-20 pb-12 px-4 relative flex items-center justify-center overflow-hidden">
            ...
            {/* Background elements */}
            <div className="absolute top-1/4 -left-20 w-96 h-96 bg-slate-400 rounded-full mix-blend-multiply filter blur-[128px] opacity-20 animate-float"></div>
                ...
                <div className="glass-panel p-8 md:p-10 rounded-3xl relative overflow-hidden backdrop-blur-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-900/50 text-white pl-11 pr-4 py-3.5 rounded-xl border border-slate-700/50 focus:border-white/50 focus:ring-2 focus:ring-white/10 outline-none transition-all placeholder:text-slate-600"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-900/50 text-white pl-11 pr-12 py-3.5 rounded-xl border border-slate-700/50 focus:border-white/50 focus:ring-2 focus:ring-white/10 outline-none transition-all placeholder:text-slate-600"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={isLoading}
                            className={`w-full mt-4 bg-white/10 hover:bg-white/20 border border-white/30 hover:border-white/60 px-6 py-4 rounded-xl font-bold text-lg text-white transition-all flex items-center justify-center gap-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
